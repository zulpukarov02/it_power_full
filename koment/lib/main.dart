...
// State<MyHomePage> ==>StatefulWidget MyHomePage сыяктуу, сиз, адатта, ошол виджеттин өзгөрүлүүчү абалына ээ болгон тиешелүү State<MyHomePage>классын түзөсүз. Бул абал классы өзгөртүүлөр талап кылынганда кайра түзүлөт жана ал виджеттин абалын башкарууга жана абал өзгөргөндө UI жаңыртууларына жооп берет.
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              '$_counter',
              // Theme.of(context).textTheme.headline4 ==> Theme.of(контекст): Берилген BuildContext(контекст) үчүн виджет дарагынан учурдагы тема дайындарын алуу үчүн колдонулат.
              //textTheme: textTheme ThemeData классынын касиети жана колдонмоңуздагы тексттин ар кандай деңгээлдери үчүн демейки текст стилдерин аныктаган текст стилдеринин жыйындысын камтыйт.
